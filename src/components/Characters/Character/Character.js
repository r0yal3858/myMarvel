  ...
  return (
    <>
      <div className="character__container">
        ...
        <div className="character__deatils">
          <div className="details__title"></div>
          <div className="details__description"></div>
          <div className="details__creators"></div>
          <div className="details__comics"></div>
          <div className="details__events"></div>
          <div className="details__series"></div>
        </div>
      </div>
    </>
  );
